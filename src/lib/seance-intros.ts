...
export const SEANCE_INTROS: SeanceIntro[] = [
  ...
  },
  {
    ...
    steps: [
      "Repensez à tout ce qu'on a vu",
      "Écrivez librement",
      "Pas besoin d'une idée parfaite",
      "Soumettez votre carnet",
    ],
    color: "#8B5CF6",
    icon: "📓",
    duration: "10 min",
  ...
  },
  {
    ...
    steps: [
      "Choisir une émotion",
      "Construire votre scène avec des jetons",
      "L'IA vous donne un retour",
      "Soumettez votre scène",
    ],
    color: "#EC4899",
    icon: "🎭",
    duration: "25 min",
  ...
  // ── MODULE 10 — IMAGINATION ──
  {
    ...
    description:
      "Une image, une question : « Et si cette scène était le début d'un film ? ». Libérez votre imagination !",
    steps: [
      "Observer l'image projetée",
      "Écrire votre « Et si... »",
      "Répondre au QCM narratif",
      "Partager dans la banque d'idées",
    ],
    color: "#06B6D4",
    icon: "✨",
    duration: "25 min",
  },
  {
    ...
    steps: [
      "Créer un personnage (avatar)",
      "Choisir objectif + obstacle",
      "Assembler le pitch",
      "Test chrono 30 secondes",
      "Confrontation + vote",
    ],
    color: "#06B6D4",
    icon: "🎤",
  ...
  },
  {
    ...
    steps: [
      "Découvrir les postes de production",
      "Répartir votre budget",
      "Voir la moyenne de la classe",
      "Débattre des choix",
    ],
    color: "#FF6B35",
    icon: "💰",
  ...
  // ── MODULE 11 — CINÉ-DÉBAT ──
  {
    ...
    steps: [
      "Observer le stimulus (citation, affiche ou scène)",
      "Lire la question d'analyse",
      "Répondre ou débattre",
      "Confronter les réponses de la classe",
    ],
    color: "#E11D48",
    icon: "📽️",
    duration: "25 min",
  },
  {
    ...
    steps: [
      "Regarder la scène ou lire la citation",
  ...
  },
  {
    ...
    steps: [
      "Analyser le personnage présenté",
      "Prendre position (héros ou anti-héros ?)",
      "Argumenter votre choix",
      "Débat collectif + vote",
    ],
    color: "#E11D48",
    icon: "🦸",
    duration: "25 min",
  },
  {
    ...
    steps: [
      "Découvrir les coulisses présentées",
  ...
  // ── MODULE 3 — LE HÉROS ──
  {
    ...
    steps: [
      ...
      "Construire le portrait du héros",
    ],
    color: "#FF6B35",
    icon: "🦸",
    duration: "25 min",
  ...
  },
  {
    ...
    steps: [
      ...
      "Formuler le thème",
      "Voter pour la meilleure formulation",
      "Synthèse collective",
    ],
    color: "#FF6B35",
    icon: "🔍",
