      ...
      <section className="space-y-6">
        <div>
          ...
          <p className="text-slate-300 leading-relaxed">
            ...
            Guidelines (WCAG 2.1 niveau AA). L&apos;accessibilite numerique est
            un enjeu essentiel, en particulier pour un outil pedagogique destine
            a tous les eleves.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="text-slate-300 space-y-2">
            ...
            <li>
              Le flux de jeu en temps reel (page /play) peut manquer
              d&apos;annonces pour les lecteurs d&apos;ecran
            </li>
            <li>
              Certains formulaires n&apos;ont pas encore de messages
              d&apos;erreur associes par ARIA
            </li>
            <li>
              Les illustrations SVG decoratives n&apos;ont pas toutes
        ...
        <div>
          ...
          <p className="text-slate-300 leading-relaxed">
            ...
            contacter a :{" "}
            <a
              href="mailto:accessibilite@banlieuwood.fr"
