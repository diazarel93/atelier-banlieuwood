...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    description: "Créer un personnage, définir son objectif, pitcher l'histoire en 60 secondes.",
  ...
  // ── PHASE 2 : LE SCÉNARIO ──
  {
    ...
    title: "Le Scénario",
    subtitle: "Scénario",
    description: "Écrire le scénario complet — structure, dialogues, scènes clés. Tout part de leur idée.",
    teacherNote: "Ils ont les ingrédients. Maintenant ils écrivent.",
    color: "#10B981",
  ...
  // ── PHASE 3 : LA PRODUCTION ──
  {
    ...
    title: "La Production",
    subtitle: "Production",
    description: "Choisir les acteurs, les lieux de tournage, la musique. Donner vie au scénario.",
    teacherNote: "Les élèves passent de l'imaginaire au concret.",
    color: "#F59E0B",
    gradient: "from-[#F59E0B] to-[#D97706]",
    iconKey: "users",
    duration: "40 min",
  ...
  // ── PHASE 4 : PLATEAU ──
  {
    ...
    title: "Le Plateau",
    subtitle: "Plateau",
    description: "Mise en scène — jouer, diriger, improviser. Donner corps aux personnages.",
    teacherNote: "Les élèves passent devant et derrière la caméra.",
    color: "#EF4444",
