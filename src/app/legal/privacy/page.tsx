      ...
      <section className="space-y-6">
        ...
        <div>
          ...
          <div className="text-slate-300 leading-relaxed space-y-3">
            <p>
              <strong className="text-white">Facilitateurs (enseignants) :</strong>
            </p>
            ...
            <p>
              <strong className="text-white">Joueurs (eleves) :</strong>
            </p>
            <ul className="space-y-1">
            ...
            <p>
              <strong className="text-white">Important :</strong> Les joueurs
        ...
        <div>
          ...
          <ul className="text-slate-300 space-y-2">
            <li>
              <strong className="text-white">Interet legitime :</strong>{" "}
            ...
            <li>
              <strong className="text-white">Obligation legale :</strong>{" "}
        ...
        <div>
          ...
          <ul className="text-slate-300 space-y-2">
            <li>
              <strong className="text-white">Sessions et reponses :</strong>{" "}
              conservees 12 mois apres la derniere activite, puis supprimees
              automatiquement
            </li>
            <li>
              <strong className="text-white">Comptes facilitateurs :</strong>{" "}
              conserves tant que le compte est actif, supprimes 6 mois apres
              la derniere connexion
            </li>
            <li>
              <strong className="text-white">Logs techniques :</strong>{" "}
