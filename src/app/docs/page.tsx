      ...
      <section className="pt-28 pb-20 px-6">
        <div className="max-w-[1200px] mx-auto">
            ...
            {TABS.map((tab, i) => (
              <button
                ...
                className={`px-5 py-2.5 text-[13px] font-semibold whitespace-nowrap border-b-2 transition-colors ${
                  i === 0 ? "border-b-2 border-bw-primary" : "text-white/35 border-transparent hover:text-white/60"
                }`}
                style={i === 0 ? { color: "var(--color-bw-primary)" } : undefined}
              >
                {tab}
              </button>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {RESOURCES.map((r) => (
              <a
                ...
                className="rounded-2xl bg-[#141210] border border-[#2a2420] p-6 hover:border-bw-primary/25 hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all relative overflow-hidden group block"
              >
                <div
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-white/25 group-hover:text-bw-primary/60 transition-colors">
                    Demander →
                  </span>
                </div>
              </a>
          ...
          <div className="mt-12 text-center rounded-2xl border border-[#2a2420] bg-[#141210] px-8 py-10">
            <div className="font-cinema text-[13px] tracking-[0.2em] mb-3" style={{ color: "var(--color-bw-primary)" }}>
              ACCÈS SUR DEMANDE
            </div>
            ...
            <a
              ...
              style={{ background: "var(--color-bw-primary)", boxShadow: "0 4px 20px rgba(255,107,53,0.35)" }}
            >
              Contacter l&apos;équipe
            </a>
          </div>
