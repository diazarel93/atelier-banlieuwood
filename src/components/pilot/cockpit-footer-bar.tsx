                ...
                >
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">
                      Relancer{notRespondedStudents.length > 0 ? ` (${notRespondedStudents.length})` : ""}
                    </span>
                    <span className="sm:hidden">
                      {notRespondedStudents.length > 0 ? notRespondedStudents.length : ""}
                    </span>
                  </button>
                  <button
          ...
          <div ref={footerCtaRef} className="flex items-center gap-3 flex-shrink-0">
            ...
            <div className="min-w-[180px]">
              {sessionStatus === "waiting" ? (
                  ...
                  onClick={() => {
                    if (isPreviewing) {
                      ...
                      updateSession.mutate({
                        current_situation_index: displayIndex,
                        status: "responding",
                        timer_ends_at: null,
                      });
                    } else {
                ...
                <div
                  className="w-full py-2.5 rounded-lg text-sm text-center bg-bw-elevated text-bw-muted border border-black/[0.06]"
                ...
                >
                  {sessionStatus === "responding" ? (
                    <span className="flex items-center justify-center gap-2">
                      ...
                      En attente...{" "}
                      <span className="text-bw-text font-semibold tabular-nums">
                        {respondedCount}/{activeStudentCount}
                      </span>
                    </span>
                  ) : sessionStatus === "voting" ? (
                    <span className="flex items-center justify-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-bw-violet animate-pulse" />
                      Vote en cours...{" "}
                      <span className="text-bw-text font-semibold tabular-nums">{voteData?.totalVotes || 0} votes</span>
                    </span>
                  ) : (
                    <span className="flex items-center justify-center gap-2">
