      ...
      <div className="min-h-dvh bg-[#0d0b09] flex flex-col items-center justify-center px-4 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-sm text-bw-muted">
            Un lien de reinitialisation a ete envoye a <strong className="text-bw-ink">{email}</strong>. Verifie ta
            boite mail (et les spams).
          </p>
          <Button
            variant="ghost"
            onClick={() => {
    ...
    <div className="min-h-dvh bg-[#0d0b09] flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center space-y-4">
          ...
          >
            {forgotMode ? "Reinitialiser le mot de passe" : isSignUp ? "Creer un compte" : "Connexion facilitateur"}
          </motion.p>
        </div>
        ...
        >
          ...
          {!forgotMode && (
            <Button
              ...
              className="w-full text-bw-muted hover:text-bw-ink hover:bg-white/[0.03] rounded-xl transition-colors cursor-pointer"
            >
              {isSignUp ? "Deja un compte ? Se connecter" : "Pas encore de compte ? S'inscrire"}
            </Button>
          )}
