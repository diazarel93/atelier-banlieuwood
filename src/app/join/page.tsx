...
function JoinForm() {
  ...
  return (
    <div className="min-h-dvh bg-bw-bg flex flex-col items-center justify-center px-4 relative overflow-hidden">
      {/* Ambient teal glow */}
...
export default function JoinPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-dvh bg-bw-bg flex items-center justify-center">
