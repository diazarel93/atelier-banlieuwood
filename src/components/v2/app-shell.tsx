...
export function AppShellV2({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-dvh flex">
      ...
      <div
        className={cn(
          "lg:hidden fixed top-0 left-0 bottom-0 z-50 w-[280px] bg-[var(--sidebar)] shadow-2xl flex flex-col transition-transform duration-300 ease-out border-r border-[var(--sidebar-border)]",
