...
export const SEANCE_INTROS: SeanceIntro[] = [
  ...
  },
  {
    ...
    description: "Créez votre personnage, définissez son objectif, et pitchez l'histoire en 60 secondes !",
    steps: ["Créer un personnage (avatar)", "Choisir objectif + obstacle", "Assembler le pitch", "Test chrono 60 secondes", "Confrontation + vote"],
    color: "#06B6D4",
    icon: "🎤",
    duration: "30 min",
  },
