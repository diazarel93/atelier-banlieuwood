...
export function ChronoTestState({ module10, sessionId, studentId, onDone }: ChronoTestStateProps) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={running && isLow ? { scale: [1, 1.06, 1], opacity: 1 } : { scale: 1, opacity: 1 }}
        transition={
          running && isLow
      ...
      >
        {done
          ? "Chrono terminé ! Bien joué"
          : running
            ? "Parle calmement, comme si tu racontais ton idée à un adulte"
            : "Appuie sur START quand tu es prêt"}
      </motion.p>
