  ...
  return (
    <div className="min-h-screen bg-bw-bg">
      ...
      <nav
        ...
        style={{ background: "rgba(15,17,24,0.85)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}
      >
      ...
      <footer className="border-t border-white/[0.06] px-6 py-8">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/legal/accessibility" className="text-xs text-bw-muted hover:text-bw-heading transition-colors">
              Accessibilite
            </Link>
          </div>
        </div>
