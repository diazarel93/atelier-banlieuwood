...
const TALENT_LABELS: Record<string, { label: string; emoji: string; color: string }> = {
  jeu: { label: "Jeu d'acteur", emoji: "🎭", color: "var(--color-bw-primary, var(--color-bw-primary))" },
  image: { label: "Image & Visuel", emoji: "📸", color: "var(--color-bw-violet, var(--color-bw-violet))" },
  technique: { label: "Technique", emoji: "🎬", color: "var(--color-bw-teal, var(--color-bw-teal))" },
};
