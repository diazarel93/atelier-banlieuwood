...
export function EtsiWriterState({ module10, sessionId, studentId, onDone }: EtsiWriterStateProps) {
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        {phase === "select3" && (
          ...
          >
            <p className="text-sm text-bw-muted text-center">
              Choisis <strong className="text-bw-text">3 images</strong> qui t&apos;inspirent
            </p>
        ...
        {phase === "narrow1" && (
          ...
          >
            <p className="text-sm text-bw-muted text-center">
              Maintenant, choisis <strong className="text-bw-text">1 seule image</strong> pour écrire
            </p>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <motion.p
                ...
                className="text-sm text-bw-text font-medium"
              >
                Une histoire, c&apos;est quand l&apos;étincelle devient un{" "}
                <strong className="text-amber-400">feu</strong>.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                Ton &laquo;&nbsp;Et si...&nbsp;&raquo; n&apos;est pas encore une histoire complète. C&apos;est un début.
        ...
        {phase === "write" && (
          ...
          >
            ...
            {module10.helpEnabled ? (
              ...
              <p className="text-xs text-bw-muted/50 italic">
                L&apos;aide sera activée par l&apos;intervenant si besoin
              </p>
            )}
            <AnimatePresence>
              {helpHint && (
