  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold cursor-pointer rounded-xl outline-none transition-all duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 focus-visible:ring-2 focus-visible:ring-bw-primary/30 focus-visible:ring-offset-2 focus-visible:ring-offset-bw-bg active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        teal:
          "btn-glow bg-gradient-to-br from-bw-teal to-bw-teal-500 text-white shadow-bw-glow-teal hover:shadow-[0_0_32px_rgba(78,205,196,0.4),0_6px_24px_rgba(78,205,196,0.25)] hover:brightness-110",
        // Gold -- prestige
        gold:
          "btn-glow bg-gradient-to-br from-bw-gold to-bw-gold-500 text-white shadow-bw-glow-gold hover:shadow-[0_0_32px_rgba(212,168,67,0.35),0_6px_24px_rgba(212,168,67,0.2)] hover:brightness-110",
        // Violet -- AI actions
        violet:
        ...
        ghost:
          "text-bw-muted bg-transparent hover:bg-white/[0.04] hover:text-bw-heading rounded-xl",
        // Destructive
        destructive:
        ...
        // Link
        link:
          "text-bw-primary underline-offset-4 hover:underline p-0 h-auto rounded-none",
      },
      size: {
