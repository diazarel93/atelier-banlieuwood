...
export function Module1Cockpit({ isPositioning, isImage, module1Data, currentQIndex, activeStudentCount, isPreviewing }: Module1CockpitProps) {
  return (
    <>
      {/* M1 Positioning: option distribution bars */}
      {isPositioning && module1Data?.type === "positioning" && !isPreviewing && module1Data.questions?.[currentQIndex]?.options && (() => {
